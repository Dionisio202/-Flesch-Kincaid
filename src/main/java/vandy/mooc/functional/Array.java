...
/**
 * A generic unsynchronized array class implemented via a single test
 * contiguous buffer.
 */
...
public class Array<E>
    ...
    public E remove(int index) {
        ...
        mElementData[--mSize] = null; // Let GC do its work
    ...
    public E get(int index) {
        ...
        rangeCheck(index);
        @SuppressWarnings("unchecked")
        E element = (E) mElementData[index];
        return element;
    }
    ...
    public class ArrayIterator implements Iterator<E> {
        ...
        public E next() {
            ...
            @SuppressWarnings("unchecked")
            E element = (E) mElementData[mCursor];
            mLastRet = mCursor;
            mCursor++;
            return element;
        }
    ...
    public void replaceAll(UnaryOperator<E> operator) {
        ...
        for (int i = 0; i < mSize; i++) {
            ...
            mElementData[i] = operator.apply(element);
        }
    }
